#ifndef NPYMATH_HALF_HPP
#define NPYMATH_HALF_HPP
...
class Half final {
  public:
    ...
    static constexpr bool kNativeConversion = (
        ...
        #if defined(NPYMATH_HAVE_FP16) || defined(NPYMATH_HAVE_VSX3)
            true
        #else
            false
        #endif
        ...
        #if defined(NPYMATH_HAVE_AVX512FP16) || defined(NPYMATH_HAVE_VSX3)
            true
        #else
            false
        #endif
